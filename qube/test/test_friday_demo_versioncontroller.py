...
HELLO_VERSION = "/v1/friday_demo/version"
...
class Testfriday_demoVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_friday_demo_default_version(self, *args, **kwargs):
    ...
    def test_friday_demo_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
